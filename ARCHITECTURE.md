...
[`test_data` folder](crates/dt-tools-parser/test_data) to get an idea of how source
code is parsed.


```dts
// Written to ./crates/dt-tools-parser/a.dts
/dts-v1/;

/ {};
```
```console
$ cargo run --example=test_parser ./crates/dt-tools-parser/a.dts
    Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.09s
     Running `target/debug/examples/test_parser ./crates/dt-tools-parser/a.dts`
Parsed!
SourceFile@0..17
  Directive@0..9
...
```
```console
$ cargo run --example=test_lexer ./crates/dt-tools-parser/a.dts
    Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.10s
     Running `target/debug/examples/test_lexer ./crates/dt-tools-parser/a.dts`
‘/dts-v1/‘ "/dts-v1/" 0..8
‘;’ ";" 8..9
whitespace "\n\n" 9..11
‘/’ "/" 11..12
